...
namespace Modules\ModuleTurkishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Turkish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Turkish UI translations from Messages/tr/ directory
 * - Turkish voice prompts from Sounds/tr-tr/ directory
 *
 ...
 *
 * @package Modules\ModuleTurkishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleTurkishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Turkish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Turkish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Turkish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Turkish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Turkish Language Pack uninstalled successfully',
            LOG_INFO
        );
